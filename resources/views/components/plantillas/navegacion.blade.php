<x-plantillas.plantilla>
    <div clasZ>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <aside class="mt-3 w-64" aria-label="Sidebar">
                <div class=" py-2  overflow-y-auto rounded   dark:bg-gray-800">
                    <div class="mt-5 font-semibold ">
                        ...
                        <ul class="">
                            <li class="list-menu">
                                <a  class="item-menu" href="{{ route('asistencias') }}">
            ...
            <div class=" flex-grow ">
                <nav x-data="{ open: false }" class="bg-gray-200 sm:bg-cyan-700 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
